  ...
  return (
    <section>
      <div className="container flex max-w-6xl flex-col gap-10 py-32 sm:gap-y-16">
        <HeaderSection
          label="Testimonials"
          title="What creators say when they get time back."
          subtitle="Anime recap creators and faceless editors care about output, workflow sanity, and fewer copyright surprises. That’s exactly what we’re building for."
        />
